...
/obj/structure/roguemachine/steward/Topic(href, href_list)
	...
	if(href_list["payroll"])
		var/list/L = list(GLOB.court_positions) + list(GLOB.garrison_positions) + list(GLOB.church_positions) + list(GLOB.towner_positions) + list(GLOB.peasant_positions) + list(GLOB.apprentices_positions)
